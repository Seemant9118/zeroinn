...
export default function Hero() {
    return (
        <div className="bg-primary min-h-[90vh] w-full lg:px-28 md:px-20 px-5 grid lg:grid-cols-2 lg:grid-rows-1 grid-cols-1 grid-rows-2 gap-3">
            <div className="flex flex-col gap-10 justify-center items-start">
                ...
                <div id="btnGroup" className="flex sm:flex-row flex-col gap-2">
                    ...
                    <button className="border w-40 h-12 p-2 rounded text-white font-bold sm:text-base text-sm flex justify-center items-center gap-2 bg-[#1c3ab6] hover:border-2 hover:bg-primary"><PlayCircle size={28} strokeWidth={1.25} absoluteStrokeWidth />Watch Intro</button>
                </div>
            </div>
